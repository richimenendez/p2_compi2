...
import webbrowser
from gramaticaC import ejecutar as ejecutarC
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "IDE P2 RICARDO MENENDEZ- DESARROLADO POR:  HAROLDO PABLO ARIAS MOLINA"))
        ...
        self.menuCMinor.setTitle(_translate("MainWindow", "CMinor"))
        self.menuReportes.setTitle(_translate("MainWindow", "Reportes Augus"))
        self.menuReportesC.setTitle(_translate("MainWindow", "Reportes C-"))
